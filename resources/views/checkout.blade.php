            ...
            <div class="row g-5">
                <div class="col-md-12 col-lg-6 col-xl-7">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-control" id="address" name="address" placeholder="House Number Street Name">
                    </div>
                    <div class="form-item">
                        <label class="form-label my-3" for="town">Town/City<sup>*</sup></label>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{ asset('images/'.$data->photo) }}" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                        </div>
                                    </th>
                                    <td class="py-5">{{ $data->name }}</td>
                                    <td class="py-5">{{ number_format((float) $data->price, 2, '.', '') }}₹</td>
                                    <td class="py-5">{{ $data->qty }}</td>
                                    <td class="py-5">{{ number_format((float) $data->price * $data->qty, 2, '.', '') }}₹</td>
                                </tr>
                                @endforeach
