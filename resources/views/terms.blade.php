...
<div class="container mt-5 pt-5"> 
    <div class="card">
        <div class="card-body">
            <header>
                <h1 class="card-title text-center">Terms of Use</h1>
            </header>
            <section class="pt-4">
                <h2>1. Introduction</h2>
                <p>Welcome to our website. By accessing or using our site, you agree to comply with these Terms of Use. If you do not agree with these terms, please do not use our site.</p>
            </section>
            <section>
                <h2>2. Use License</h2>
